...
> ⚠️ **RE-ORDERED 2026-07-26** by the highlight-hierarchy decision
> (`specs/notes/2026-07-26-highlight-hierarchy-decision.md` in the app repo). The **savings hero
> is retired** — the money hook is a promise the app can't keep on day one, and it measured
> conversion-*negative* for 6 of 12 sentinel personas. **The safe-window countdown leads;**
...
1. **Safe window** — hero. The countdown band (started · remaining · ends). "Know when a bottle's no longer safe." *(frame not yet produced)*
2. **Food story / allergens** — the retention story, shown early. "Introduce foods with confidence."
3. **Waste less** — the rational alibi, framed as waste only. "See the formula you're not wasting."
